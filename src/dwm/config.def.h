...
static const char col_cyan[]        = "#994000";
...
static const char *powermenucmd[] = { "powermenu", dmenufont, col_gray1, col_gray3, col_cyan, col_gray4, NULL };
static const char *termcmd[]  = { "st", NULL };

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY,                       XK_o,	spawn,	   {.v = powermenucmd} },
	...
	{ 0,                            XK_Print,  spawn, 	   SHCMD("scrot -s -f -z /tmp/screenshot.png && xclip -selection clipboard -t image/png -i \"$(ls -t /tmp/screenshot*.png | head -n 1)\"") },
